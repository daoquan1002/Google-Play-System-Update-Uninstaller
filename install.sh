...
on_install() {
  ...
  ui_print "- Delete and freeze active folder"
  rm -r /data/apex/active
  touch /data/apex/active
  ui_print "- Success! Restart your phone to see results."
  ui_print "- Remember don't update again to avoid errors."
}
